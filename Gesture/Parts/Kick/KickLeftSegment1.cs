...
{
    class KickLeftSegment1 : GestureSegment
    {
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
            ...
            if (skeleton.Joints[JointType.AnkleLeft].Position.Z < skeleton.Joints[JointType.KneeLeft].Position.Z)
            {
                ...
                if (skeleton.Joints[JointType.KneeLeft].Position.Z < skeleton.Joints[JointType.HipCenter].Position.Z)
                {
                    ...
                    if ((Math.Abs(skeleton.Joints[JointType.HipCenter].Position.Y-skeleton.Joints[JointType.AnkleLeft].Position.Y)<0.50)&&(Math.Abs(skeleton.Joints[JointType.HipCenter].Position.Y-skeleton.Joints[JointType.AnkleLeft].Position.Y)>0.33))
                    {
