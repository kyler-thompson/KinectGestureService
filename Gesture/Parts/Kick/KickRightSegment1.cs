...
{
    class KickRightSegment1 : GestureSegment
    {
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
            ...
            if (skeleton.Joints[JointType.AnkleRight].Position.Z < skeleton.Joints[JointType.KneeRight].Position.Z)
            {
                ...
                if (skeleton.Joints[JointType.KneeRight].Position.Z < skeleton.Joints[JointType.HipCenter].Position.Z)
                {
                    ...
                    if ((Math.Abs(skeleton.Joints[JointType.HipCenter].Position.Y-skeleton.Joints[JointType.AnkleRight].Position.Y) < 0.50)&&(Math.Abs(skeleton.Joints[JointType.HipCenter].Position.Y-skeleton.Joints[JointType.AnkleRight].Position.Y) > 0.33))
                    {
